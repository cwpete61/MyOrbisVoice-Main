...
*/
// Spanish variant of app.jsx — identical logic, Spanish TopNav labels.
// The component names (Hero, AgentSystem, etc.) resolve to the Spanish
// implementations because hero-es.jsx, agents-es.jsx, etc. override the
// same window.* assignments AFTER this script's expectations are set.
  ...
  return (
    <nav className="nav">
      <div className="container nav-inner">
        <a href="/es/" className="brand-mark">
        ...
        <div className="nav-links">
          ...
          <a href="/es/how-it-works.html">Cómo funciona</a>
        ...
        <div className="nav-cta">
          ...
          <a href="https://app.myorbisvoice.com/login" className="btn btn-ghost" style={{padding: "9px 16px", fontSize: 14}}>Iniciar sesión</a>
          <a href="https://app.myorbisvoice.com/signup" className="btn btn-signup" style={{padding: "10px 18px", fontSize: 14}}>¡Regístrate AHORA!</a>
          <a href="#orby-demo" className="btn btn-primary" style={{padding: "10px 18px", fontSize: 14}}>Habla con Orby</a>
          <button
            type="button"
