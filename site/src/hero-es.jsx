      ...
      <div className="container hero-inner">
        <div className="hero-copy">
          ...
          <h1 className="h-display hero-h1">
            No creas <br />
            <span className="hero-h1-line2">lo que decimos que <span className="hero-h1-accent">Orby</span> puede hacer…</span>
          </h1>

          <p className="hero-sub">
            Mientras lees esto, un competidor acaba de agendar al cliente que no pudo comunicarse contigo.
            <strong>Orby es la única IA que contesta en menos de un segundo, agenda en tu calendario real y persigue el seguimiento por SMS, correo y WhatsApp — desde una sola plataforma, en inglés y español.</strong>
            Los demás te venden una pieza. Nosotros somos los únicos que cierran el ciclo.
          </p>
