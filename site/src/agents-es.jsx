...
const AGENTS = [
  { id: "orch", name: "Orchestrator", role: "Enruta a mitad de llamada al especialista correcto", color: "#3FE3E3", glyph: "◎" },
  { id: "secy", name: "Secretario", role: "Contesta, toma mensajes, maneja fuera de horario", color: "#7C9CFF", glyph: "✉" },
  { id: "appt", name: "Citas", role: "Agenda, reprograma y cancela en tu calendario", color: "#3FE3E3", glyph: "▣" },
  { id: "sales", name: "Ventas", role: "Califica leads, jala precios en vivo desde el DNA", color: "#FFB341", glyph: "$" },
  { id: "cs", name: "Servicio al cliente", role: "Resuelve incidencias, escala según tus reglas", color: "#FF7C7C", glyph: "?" },
  { id: "mkt", name: "Marketing", role: "Nutre leads, despacha campañas multicanal", color: "#C77CFF", glyph: "✦" },
  { id: "asst", name: "Asistente", role: "Comodín para intenciones sin enrutar", color: "#9AE6B4", glyph: "•" },
];

const HANDOFF_SCENE = [
  { who: "caller", text: "Hola, llamo por sus planes de servicio." },
  { who: "agent", id: "secy", text: "Claro, déjame pasarte con la persona indicada." },
  { route: "secy", to: "sales" },
  { who: "agent", id: "sales", text: "Tenemos tres niveles, desde $497/mes. ¿De qué giro es tu negocio?" },
  { who: "caller", text: "Techado. Oye, ¿también me puedes agendar para el próximo martes?" },
  { route: "sales", to: "appt" },
  { who: "agent", id: "appt", text: "Martes a las 10 AM está libre. Confirmando ahora." },
];
    ...
    <section className="agents-section" data-screen-label="03 Seven Agents">
      ...
      <div className="container">
        <div className="section-head">
          <div className="eyebrow">El diferenciador</div>
          <h2 className="h-section">
            Orby no es solo un Agente. <br/>
            <span style={{color: "var(--accent-hi)"}}>Son siete agentes especialistas</span> con una sola voz.
          </h2>
          <p>
            Detrás de un solo saludo cálido, un Orchestrator pasa al cliente a mitad de conversación al especialista correcto —
            Secretario, Citas, Ventas, Servicio, Marketing, Asistente. El cliente nunca escucha la transferencia. Tú nunca contratas siete personas.
          </p>
        </div>
          ...
          <div className="agent-panel">
            <div className="ap-head">
              <div className="mono" style={{fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--text-3)"}}>
                Transferencia en vivo · mismo cliente · cero espera
              </div>
            </div>
            <div className="ap-transcript">
              {transcript.length === 0 && (
                <div style={{textAlign: "center", padding: 40, color: "var(--text-3)", fontSize: 13}}>
                  Escuchando señales de enrutamiento…
                </div>
              )}
              {transcript.map((t, i) => {
                if (t.who === "caller") {
            ...
            <div className="ap-foot">
              <span className="mono" style={{fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--text-3)"}}>
                Gemini Live · un solo runtime · 7 capas de prompt
              </span>
            </div>
          </div>
        </div>
