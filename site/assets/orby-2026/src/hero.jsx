      ...
      <div className="container hero-inner">
        <div className="hero-copy">
          ...
          <h1 className="h-display hero-h1">
            Don't Take Our Word for <br />
            <span className="hero-h1-accent">What Orby Can Do…</span>
          </h1>

          <p className="hero-sub">
            One AI receptionist that <strong>answers every call</strong>, <strong>books on your calendar</strong>,
            and <strong>follows up across SMS, email & WhatsApp</strong> — while you're elbow-deep in actual work.
            Replaces 4–6 separate tools. Speaks English & Spanish. Never sleeps.
          </p>
