...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/agent-studio', label: 'Agent Studio', icon: <Icon d="M8 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm4.5-7.5l1.5 1.5M3.5 11.5l1.5 1.5M12 8h2M2 8H0M8 2V0M8 14v2" /> },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/outbound',      label: 'Outbound Caller', icon: <Icon d="M15 3l-4 4M3 13l4-4M11 7l2 2-6 6-2-2zm-3 7l-3 2 1-3" /> },
{ href: '/conversations',  label: 'Conversations', icon: <Icon d="M2 4h12a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H5l-3 2V5a1 1 0 0 1 1-1zm3 3h6M5 9h4" /> },
  ...
  },
  {
    label: 'Account',
    items: [
      { href: '/usage',    label: 'Usage',    icon: <Icon d="M2 12h2V8H2zm3 0h2V4H5zm3 0h2V6H8zm3 0h2v-3h-2zM2 14h12" /> },
      ...
      { href: '/help',     label: 'Help',     icon: <Icon d="M8 2a6 6 0 1 1 0 12A6 6 0 0 1 8 2zm0 4a1.5 1.5 0 0 0-1.5 1.5h1a.5.5 0 0 1 1 0c0 .5-.5.75-.87 1.06A1.5 1.5 0 0 0 7 9.5h1c0-.34.13-.5.63-.84C9.38 8.25 10 7.75 10 6.5A2.5 2.5 0 0 0 8 4zM7.5 11h1v1h-1z" /> },
    ],
  },
]
