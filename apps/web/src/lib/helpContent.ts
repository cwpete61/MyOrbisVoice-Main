...
export const HELP_CONTENT: HelpSection[] = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        steps: [
          { title: 'Step 1 — Fill in Business DNA', body: 'Go to Business DNA in the sidebar. Complete at minimum: your business name, industry, primary service, operating hours, and one escalation condition. Publish the draft when ready.', screenshots: [{ filename: 'nav-business-dna.png', caption: 'Sidebar \'Business DNA\' link highlighted, in the Build Your Agent section' }] },
          { title: 'Step 2 — Write your Master Prompt', body: 'Go to Prompts. Create a new prompt with scope "Master". Describe your agent\'s persona, tone, and primary goal in plain language. Publish it.', screenshots: [{ filename: 'nav-prompts.png', caption: 'Sidebar \'Prompts\' link highlighted, in the Build Your Agent section' }] },
