...
const C = {
  en: {
    ...
    seats: 'How many members on your team or agents?', teamDeals: 'Team deals closed (last 12 months)',
  ...
  es: {
    ...
    seats: '¿Cuántos miembros tiene tu equipo o agentes?', teamDeals: 'Operaciones del equipo (últimos 12 meses)',
