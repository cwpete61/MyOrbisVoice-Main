...
// Base: public/source/orby-explainer-final.mp4 (talking head on #FCFCFC near-white).
...
const WINS: Win[] = [
  ...
  { t: 87.2,  side: 'R', g: <LeakCard num="02" name="Invisible Online" color={LK.invis} line="No map-pack presence. Thin reviews, weak categories, poor local content — a good business looks absent at the exact moment the buyer is choosing." /> },
  { t: 105.2, side: 'L', g: <LeakCard num="03" name="Missed Calls" color={LK.cold} line="Ready-to-buy customer hits voicemail. By the time you call back, they've booked the competitor who answered first." /> },
  { t: 116.9, side: 'R', g: <LeakCard num="04" name="No Capture & Convert" color={LK.noproc} line="Calls, forms, ads, referrals, social, Google — leads come from everywhere, none enter one clean process. Some get called back. Some get lost." /> },
  { t: 133.0, side: 'L', g: <LeakCard num="05" name="Poor Website" color={LK.web} line="Slow loads. Buried call button. Weak booking path. The visitor leaves before your business gets a real chance." /> },
  { t: 149.1, side: 'R', g: <LeakCard num="06" name="Owner Trapped" color={LK.owner} line="Phones, quotes, reviews, texts, website fixes, staff, growth — all on you. Too many moving parts. That's how owners get buried." /> },
  { t: 173.3, side: 'L', g: <Statement eyebrow="Until Now" title={<>Without the right partnership, getting out of that cycle can feel <span style={{ color: TEAL }}>impossible.</span></>} /> },
  { t: 179.0, side: 'R', g: <Statement eyebrow="MyOrbisResults" title={<>Build the plan. Grow the business. <span style={{ color: TEAL }}>Provide human support.</span></>} sub="Not a motto. How we operate." /> },
  { t: 186.7, side: 'L', g: <TwoCol items={['Build the growth plan with you', 'Install the system around your business', 'Train your staff', 'Review the numbers', 'Stay close enough to help you run it', 'Real people, not just software']} /> },
  { t: 202.3, side: 'R', g: <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><TriMini /></div> },
  { t: 209.2, side: 'L', g: <PillarCard tag="MyOrbisLocal · Get Found" title="Find buyers ready to call" color={LK.invis} bullets={['GBP + competitor + review audit', 'Categories, keywords, ranking gaps', 'Local content + ranking signals', 'Built for when buyers are ready']} /> },
  { t: 225.0, side: 'R', g: <PillarCard tag="MyOrbisWeb · Convert" title="Turn demand into action" color={LK.web} bullets={['Mirrors your Google profile', 'Clear call / book / request actions', 'Same growth plan as local', 'Site + presence in sync']} /> },
  { t: 239.9, side: 'L', g: <PillarCard tag="MyOrbisVoice · Answer & Book" title="Capture every serious lead" color={TEALB} live bullets={['Phone, website, or booking page', 'Qualify · answer · book your calendar', 'Follow up by phone, email, text', 'English or Spanish · fast']} /> },
  { t: 265.9, side: 'R', g: <PillarCard tag="Staff Training · Make It Stick" title="System runs inside your business" color={LK.noproc} bullets={['Handoff + follow-up discipline', 'Sales process + daily workflow', 'Not just around your business', 'Inside it — every day']} /> },
  { t: 276.6, side: 'L', g: <div><div style={{ marginBottom: 18 }}><Statement eyebrow="The Real Difference" title={<>Real people <span style={{ color: TEAL }}>behind the system.</span></>} /></div><TwoCol items={['Weekly meetings', 'Growth reports', 'Clear next steps', 'Local visibility reviews', 'Website updates', 'Voice agent improvements', 'Review strategy', 'Follow-up strategy', 'Expansion planning']} /></div> },
  { t: 300.8, side: 'R', g: <Statement eyebrow="How The Loop Works" title={<>Capture demand. Convert. <span style={{ color: TEAL }}>Compound.</span></>} sub="Every call creates better business data. Better data sharpens every next move." /> },
  { t: 302.1, side: 'L', g: <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><LoopMini /></div> },
  { t: 323.2, side: 'R', g: <Statement eyebrow="Why Connected Wins" title={<>Three products. One growth system. <span style={{ color: TEAL }}>A human team behind it.</span></>} sub="A competitor with one piece can't catch a business running the full system with a team helping it grow." /> },
  { t: 333.2, side: 'L', g: <div><div style={{ marginBottom: 22 }}><Statement title={<>Any business where the <span style={{ color: TEAL }}>phone drives revenue.</span></>} /></div><Chips items={['Dental', 'Legal', 'HVAC', 'Plumbing', 'Electrical', 'Fitness', 'Beauty', 'Medical', 'Home services', 'Professional services']} /></div> },
  { t: 348.6, side: 'R', g: <Statement eyebrow="Start Here" title={<>Stop patching. <span style={{ color: TEAL }}>Start compounding.</span></>} sub="Book a free Trifecta Consultation at MyOrbisResults.com." /> },
]
...
const Presenter: React.FC = () => {
  ...
  return <OffthreadVideo src={staticFile('source/orby-explainer-final.mp4')} style={{ width: 1920, height: 1080, transform: `translateX(${x}px)` }} />
}
...
export const OrbyExplainerFinal16x9: React.FC = () => {
  return (
...
export const ORBY_FINAL_FRAMES = TOTAL
