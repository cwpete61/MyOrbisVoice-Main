...
import { MoreMitoExplainer16x9, MOREMITO_FRAMES_EN, MOREMITO_FRAMES_ES } from './compositions/MoreMitoExplainer16x9'
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* ── MoreMito × Orby homepage explainer (bilingual pair) ──────────── */}
      <Composition id="MoreMito-Explainer-16x9"    component={MoreMitoExplainer16x9} durationInFrames={MOREMITO_FRAMES_EN} fps={30} width={1920} height={1080} defaultProps={{ lang: 'en' as const, frames: MOREMITO_FRAMES_EN }} />
      <Composition id="MoreMito-Explainer-ES-16x9" component={MoreMitoExplainer16x9} durationInFrames={MOREMITO_FRAMES_ES} fps={30} width={1920} height={1080} defaultProps={{ lang: 'es' as const, frames: MOREMITO_FRAMES_ES }} />
    </>
  )
}
