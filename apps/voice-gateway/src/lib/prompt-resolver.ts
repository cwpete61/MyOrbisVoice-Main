...
export function resolveSystemPrompt(
  ...
  layers.push(
    ...
    'CRITICAL for emails and spelled-out names: letters like P/T/B/D and M/N are easily misheard over the phone. Read the email back clearly, letter by letter, and ask the caller to confirm before you save it ("I have p-e-t-e-r-s-o-n at gmail — did I get that right?"). If ANY letter is unclear, confirm it phonetically ("was that P as in Papa, or T as in Tango?"). Do NOT save an email you are not confident about — a single wrong letter sends the confirmation into a dead inbox. ' +
