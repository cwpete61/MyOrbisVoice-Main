...
export function buildToolGuidanceBlock(): string {
  return [
    ...
    '',
    'Rules — general:',
    '- Confirm details verbally before any write tool (book_appointment, send_followup_email). Read email addresses and spelled names back using the PHONETIC ALPHABET (each letter a full word — "F as in Frank," never a bare "f," which the voice mispronounces as the number "four"). Read phone numbers back in 3-3-4 grouping.',
